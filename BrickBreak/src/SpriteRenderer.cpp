...
/*
    ...
    glVertexAttribPointer(0, 2, GL_FLOAT, false, 4, (const void *) offsetof(VertexData, pos));
    glEnableVertexAttribArray(0);

    glVertexAttribPointer(1, 2, GL_FLOAT, false, 4, (const void *) offsetof(VertexData, uv));
